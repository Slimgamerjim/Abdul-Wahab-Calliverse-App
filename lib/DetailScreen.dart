...
class DetailScreen extends StatelessWidget {
  ...
  DetailScreen({required this.chatDetails});
        ...
        children: [
          Padding(
            ...
            child: Row(
              ...
              children: [
                CircleAvatar(
                  backgroundImage: AssetImage("assets/images/Ellipse 1.png"), // Replace with correct path for Ellipse 1.png
                  radius: 40,
                ),
                SizedBox(width: 16),
                Column(
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                buildImageMessage("assets/images/cat.png"), // Replace with correct path for cat.png
